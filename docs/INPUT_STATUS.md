...
> **Документ-история** — результаты валидации команд ввода (сессия P118_BEACH, debug). Актуальный формат скриптов — [`API.md`](API.md) §4; сводка граблей — [`PITFALLS.md`](PITFALLS.md).
