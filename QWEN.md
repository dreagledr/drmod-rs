...
├── script_tuning/   # Перебор таймингов core-скрипта 117 (+ timing_tune.py: детерминированный мир freeze+ticks) (python)
└── disasm/          # Дизассемблирование: scan_srm.py (PE + поиск обращений к SRM), disasm.py (обёртка llvm-objdump по RVA) + старые ps1-скрипты
