...
├── window.rs        # Окно игры: маленький размер + запоминание прямоугольника (POST /window, `%LOCALAPPDATA%\drmod\window.json`)
