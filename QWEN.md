...
| Address | Type | Field |
|---------|------|-------|
| `base + 0x17E9F9C` | `i32` | GameMenuStatus (enum 0–18; 1 = InGame, 3 = PauseMenu, 6 = CutscenePause (`cEventPauseMenu`, консольное меню со Skip), 8 = Mission Fail, 12 = Pause1, 18 = ProcessOutOfPause; таблица статусов и разбор — `docs/PHASE.md`) |
