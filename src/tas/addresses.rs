...
/// `randRange(unsigned lo, hi)` — бросок глобального LCG ИИ (thiscall `ret 8`,
/// состояние — dword в объекте `base + 0x19D0814`; `state = state*214013 +
/// 2531011`, берётся `state>>16`). Его зовут решения ИИ врага.
