...
pub use windows::Win32::Graphics::Direct3D9::IDirect3DDevice9;
...
pub trait ImguiRenderLoop {
    ...
    /// Called every frame after `BeginScene` and before the ImGui overlay.
    /// Use this to inject 3D geometry into the game's D3D9 pipeline.
    /// The z-buffer already contains the game's rendered scene,
    /// so depth testing will work correctly.
    fn render_3d(&mut self, _device: &IDirect3DDevice9) {}
